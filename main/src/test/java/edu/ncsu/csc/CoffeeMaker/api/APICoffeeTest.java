...
public class APICoffeeTest {
    ...
    public void setup () {
        ...
        ingrService.save( new Ingredient( "Coffee", 10 ) );
        ingrService.save( new Ingredient( "Milk", 10 ) );
        ingrService.save( new Ingredient( "Tea", 0 ) );
        final Recipe recipe = new Recipe();
        recipe.setName( "Coffee" );
        recipe.setPrice( 50 );
        recipe.addIngredient( ingrService.findByName( "Coffee" ), 3 );
        recipe.addIngredient( ingrService.findByName( "Milk" ), 4 );
        recipe.addIngredient( ingrService.findByName( "Tea" ), 0 );
        service.save( recipe );
    }
    ...
    //
    // final String name = "Coffee";
    // System.out.println( iService.getInventory().toString() );
